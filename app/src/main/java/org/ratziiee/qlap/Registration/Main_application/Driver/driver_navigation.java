package org.ratziiee.qlap.Registration.Main_application.Driver;
...
import org.ratziiee.qlap.Registration.Main_application.Driver.Fragments.faq_fragment;
import org.ratziiee.qlap.Registration.Main_application.Driver.Fragments.my_trips_fragment;
import org.ratziiee.qlap.Registration.Main_application.Driver.Fragments.profile_driver;
...
public class driver_navigation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transition(new my_trips_fragment());
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            transition(new profile_driver());
        } else if (id == R.id.nav_faq)
        {
            transition(new faq_fragment());
        }
