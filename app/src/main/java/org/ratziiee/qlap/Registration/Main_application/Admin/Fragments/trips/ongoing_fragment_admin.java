...
public class ongoing_fragment_admin extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter_my_trip_admin adapter=new adapter_my_trip_admin(getActivity(),list,1);
    ...
    private void init_list()
    {
        ...
        m.setStation_name("From Bole Petrol Pump Bus Stand");
        m.setDate("");
